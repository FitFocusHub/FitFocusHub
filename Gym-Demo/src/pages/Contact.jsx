...
export default function Contact() {
  ...
  return (
    <div className="contact page-transition">
      <SEO
        title="Contact"
        description="Get in touch with us for any inquiries about our gym and fitness services."
        keywords="contact gym, gym location, gym phone number"
        ...
        <div className="demo-modal-overlay" onClick={() => setShowDemoModal(false)}>
          <div className="demo-modal glass-card" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="demo-modal-message">
              You cannot send messages or make any contact submissions on this demo website. 
