...
export default function Contact() {
  ...
  return (
    <div className="contact page-transition">
      <SEO
        title="Contact"
        description="Get in touch with us for any inquiries about our restaurant and dining services."
        keywords="contact restaurant, restaurant location, restaurant phone number"
